                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                        ...
                        <ul className="list-disc list-inside text-sm text-blue-700 space-y-1">
                            <li>Documento de identidad del titular actual</li>
                            <li>Documento de identidad del nuevo titular</li>
                            <li>Constancia de CUIT/CUIL actualizada</li>
                            <li>Escritura de transferencia (si aplica)</li>
                        </ul>
                    </div>
